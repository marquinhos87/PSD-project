...
public class ProtoUtil {
    ...
    public static <T> T read(InputStream in, Parser<T> msgParser) throws IOException {
    ...
    public static void write(OutputStream out, MessageLite msg) throws IOException {
