...
%% enumerated types
-type 'MsgAuth.ClientType'() :: 'MANUFACTOR' | 'IMPORTER'.
...
-export_type(['MsgAuth'/0, 'MsgAck'/0, 'DisponibilityS'/0, 'DisponibilityN'/0, 'OrderS'/0, 'OrderN'/0, 'OrderAckS'/0, 'OrderAckI'/0, 'SubS'/0, 'SubN'/0, 'ProductionS'/0, 'ProductionM'/0, 'ResultS'/0, 'ResultI'/0, 'InfoS'/0, 'InfoI'/0, 'Server'/0]).

-spec encode_msg(#'MsgAuth'{} | #'MsgAck'{} | #'DisponibilityS'{} | #'DisponibilityN'{} | #'OrderS'{} | #'OrderN'{} | #'OrderAckS'{} | #'OrderAckI'{} | #'SubS'{} | #'SubN'{} | #'ProductionS'{} | #'ProductionM'{} | #'ResultS'{} | #'ResultI'{} | #'InfoS'{} | #'InfoI'{} | #'Server'{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#'MsgAuth'{} | #'MsgAck'{} | #'DisponibilityS'{} | #'DisponibilityN'{} | #'OrderS'{} | #'OrderN'{} | #'OrderAckS'{} | #'OrderAckI'{} | #'SubS'{} | #'SubN'{} | #'ProductionS'{} | #'ProductionM'{} | #'ResultS'{} | #'ResultI'{} | #'InfoS'{} | #'InfoI'{} | #'Server'{}, atom() | list()) -> binary().
...
encode_msg_Server(#'Server'{commonField = F1, msg = F2},
		  Bin, TrUserData) ->
    B1 = begin
	   TrF1 = id(F1, TrUserData),
    ...
    if F2 =:= undefined -> B1;
	   ...
	   case id(F2, TrUserData) of
		 ...
		 begin
		   ...
		   e_mfield_Server_m1(TrTF2, <<B1/binary, 18>>, TrUserData)
		 end;
	     {m2, TF2} ->
		 begin
		   TrTF2 = id(TF2, TrUserData),
		   e_mfield_Server_m2(TrTF2, <<B1/binary, 26>>, TrUserData)
		 end;
	     {m3, TF2} ->
		 begin
		   TrTF2 = id(TF2, TrUserData),
		   e_mfield_Server_m3(TrTF2, <<B1/binary, 34>>, TrUserData)
		 end;
	     {m4, TF2} ->
		 begin
		   TrTF2 = id(TF2, TrUserData),
		   e_mfield_Server_m4(TrTF2, <<B1/binary, 42>>, TrUserData)
		 end;
	     {m5, TF2} ->
		 begin
		   TrTF2 = id(TF2, TrUserData),
		   e_mfield_Server_m5(TrTF2, <<B1/binary, 50>>, TrUserData)
		 end;
	     {m6, TF2} ->
		 begin
		   TrTF2 = id(TF2, TrUserData),
		   e_mfield_Server_m6(TrTF2, <<B1/binary, 58>>, TrUserData)
		 end;
	     {m7, TF2} ->
		 begin
		   TrTF2 = id(TF2, TrUserData),
		   e_mfield_Server_m7(TrTF2, <<B1/binary, 66>>, TrUserData)
		 end
	   end
    end.
...
'e_enum_MsgAuth.ClientType'('MANUFACTOR', Bin,
			    _TrUserData) ->
    <<Bin/binary, 0>>;
...
dfp_read_field_def_Server(<<8, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, TrUserData) ->
    d_field_Server_commonField(Rest, Z1, Z2, F@_1, F@_2,
			       TrUserData);
dfp_read_field_def_Server(<<18, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, TrUserData) ->
    d_field_Server_m1(Rest, Z1, Z2, F@_1, F@_2, TrUserData);
dfp_read_field_def_Server(<<26, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, TrUserData) ->
    d_field_Server_m2(Rest, Z1, Z2, F@_1, F@_2, TrUserData);
dfp_read_field_def_Server(<<34, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, TrUserData) ->
    d_field_Server_m3(Rest, Z1, Z2, F@_1, F@_2, TrUserData);
dfp_read_field_def_Server(<<42, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, TrUserData) ->
    d_field_Server_m4(Rest, Z1, Z2, F@_1, F@_2, TrUserData);
dfp_read_field_def_Server(<<50, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, TrUserData) ->
    d_field_Server_m5(Rest, Z1, Z2, F@_1, F@_2, TrUserData);
dfp_read_field_def_Server(<<58, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, TrUserData) ->
    d_field_Server_m6(Rest, Z1, Z2, F@_1, F@_2, TrUserData);
dfp_read_field_def_Server(<<66, Rest/binary>>, Z1, Z2,
			  F@_1, F@_2, TrUserData) ->
    d_field_Server_m7(Rest, Z1, Z2, F@_1, F@_2, TrUserData);
dfp_read_field_def_Server(<<>>, 0, 0, F@_1, F@_2, _) ->
    #'Server'{commonField = F@_1, msg = F@_2};
...
dg_read_field_def_Server(<<0:1, X:7, Rest/binary>>, N,
    ...
    case Key of
      8 ->
	  d_field_Server_commonField(Rest, 0, 0, F@_1, F@_2,
				     TrUserData);
      18 ->
	  d_field_Server_m1(Rest, 0, 0, F@_1, F@_2, TrUserData);
      26 ->
	  d_field_Server_m2(Rest, 0, 0, F@_1, F@_2, TrUserData);
      34 ->
	  d_field_Server_m3(Rest, 0, 0, F@_1, F@_2, TrUserData);
      42 ->
	  d_field_Server_m4(Rest, 0, 0, F@_1, F@_2, TrUserData);
      50 ->
	  d_field_Server_m5(Rest, 0, 0, F@_1, F@_2, TrUserData);
      58 ->
	  d_field_Server_m6(Rest, 0, 0, F@_1, F@_2, TrUserData);
      66 ->
	  d_field_Server_m7(Rest, 0, 0, F@_1, F@_2, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_Server(Rest, 0, 0, F@_1, F@_2, TrUserData);
	    1 -> skip_64_Server(Rest, 0, 0, F@_1, F@_2, TrUserData);
	    2 ->
		skip_length_delimited_Server(Rest, 0, 0, F@_1, F@_2,
					     TrUserData);
	    3 ->
		skip_group_Server(Rest, Key bsr 3, 0, F@_1, F@_2,
				  TrUserData);
	    5 -> skip_32_Server(Rest, 0, 0, F@_1, F@_2, TrUserData)
	  end
    end;
dg_read_field_def_Server(<<>>, 0, 0, F@_1, F@_2, _) ->
    #'Server'{commonField = F@_1, msg = F@_2}.

d_field_Server_commonField(<<1:1, X:7, Rest/binary>>, N,
			   Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_Server_commonField(Rest, N + 7, X bsl N + Acc,
			       F@_1, F@_2, TrUserData);
d_field_Server_commonField(<<0:1, X:7, Rest/binary>>, N,
			   Acc, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = {begin
...
skip_varint_Server(<<1:1, _:7, Rest/binary>>, Z1, Z2,
		   F@_1, F@_2, TrUserData) ->
    skip_varint_Server(Rest, Z1, Z2, F@_1, F@_2,
		       TrUserData);
...
skip_length_delimited_Server(<<0:1, X:7, Rest/binary>>,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_Server(Rest2, 0, 0, F@_1, F@_2,
			      TrUserData).

skip_group_Server(Bin, FNum, Z2, F@_1, F@_2,
		  TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_Server(Rest, 0, Z2, F@_1, F@_2,
			      TrUserData).
...
'd_enum_MsgAuth.ClientType'(0) -> 'MANUFACTOR';
...
merge_msg_Server(#'Server'{msg = PFmsg},
		 #'Server'{commonField = NFcommonField, msg = NFmsg},
		 TrUserData) ->
    #'Server'{commonField = NFcommonField,
	      msg =
		  case {PFmsg, NFmsg} of
		    {{m1, OPFmsg}, {m1, ONFmsg}} ->
			{m1,
...
v_msg_Server(#'Server'{commonField = F1, msg = F2},
	     Path, TrUserData) ->
    v_type_int64(F1, [commonField | Path], TrUserData),
    case F2 of
      undefined -> ok;
      {m1, OF2} ->
	  v_msg_DisponibilityS(OF2, [m1, msg | Path], TrUserData);
      {m2, OF2} ->
	  v_msg_OrderS(OF2, [m2, msg | Path], TrUserData);
      {m3, OF2} ->
	  v_msg_SubS(OF2, [m3, msg | Path], TrUserData);
      {m4, OF2} ->
	  v_msg_ResultS(OF2, [m4, msg | Path], TrUserData);
      {m5, OF2} ->
	  v_msg_InfoS(OF2, [m5, msg | Path], TrUserData);
      {m6, OF2} ->
	  v_msg_ProductionS(OF2, [m6, msg | Path], TrUserData);
      {m7, OF2} ->
	  v_msg_OrderAckS(OF2, [m7, msg | Path], TrUserData);
...
'v_enum_MsgAuth.ClientType'('MANUFACTOR', _Path,
			    _TrUserData) ->
    ok;
...
'enum_value_by_symbol_MsgAuth.ClientType'('MANUFACTOR') ->
    0;
...
get_msg_containment("nefit") ->
    ['DisponibilityN', 'DisponibilityS', 'InfoI', 'InfoS',
     'MsgAck', 'MsgAuth', 'OrderAckI', 'OrderAckS', 'OrderN',
